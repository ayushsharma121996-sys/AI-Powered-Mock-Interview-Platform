    ...
    <div className="w-full max-w-md mx-auto my-12">
      <div className="glass-panel-neon-purple p-8 rounded-3xl relative overflow-hidden">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-400 mt-2">Create an account to kickstart your preparation</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-2">
            <label className="text-xs font-semibold text-gray-400 uppercase tracking-wider block">Choose Role</label>
        ...
        <div className="text-center mt-6 text-sm text-gray-400">
          ...
          <Link to="/login" className="text-cyber-light hover:underline font-semibold">
            Log In
          </Link>
        </div>
      </div>
